...
namespace StudentManagementSystem.Controllers
{
    ...
    public class SecondaryController : Controller
    {
        ...
        private static readonly string[] SecondarySubjectOptions =
        {
            "Mathematics", "English", "Science", "Social Studies", "Urdu", "Islamiyat", "Computer Science"
        };
            ...
            string? session, string? className, string? section, string? term, string? examType, string? subject)
        {
            ...
            var subjectEffective = SecondarySubjectOptions.FirstOrDefault(s => s.Equals(subjectTrim, StringComparison.OrdinalIgnoreCase))
                ?? SecondarySubjectOptions[0];
        ...
        public async Task<IActionResult> ManageResult(string? session, string? className, string? section, string? term, string? examType, string? subject)
        {
            ...
            ViewBag.Subjects = SecondarySubjectOptions;
